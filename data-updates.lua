...
update_tech("logistics", {"automation"}, {type="craft-item", item="transport-belt", count=1000})
update_tech("logistics-2", {"automation-2","logistics"}, {type="craft-item", item="transport-belt", count=10000})
update_tech("logistics-3", {"logistics-2","advanced-circuit"}, {type="craft-item", item="fast-transport-belt", count=20000})
...
update_tech("electric-energy-distribution-1", {"electronics"}, {type="craft-item", item="small-electric-pole", count=1000})
...
update_tech("lamp", {"electronics"}, {type="craft-item", item="electronic-circuit", count=500})
...
update_tech("military-4", {"military-3","explosives"}, {type="craft-item", item="piercing-rounds-magazine", count=10000})
...
update_tech("artillery", {"military-4","tank","concrete","radar"}, {type="craft-item", item="explosive-cannon-shell", count=2000})
...
update_tech("power-armor", {"modular-armor","military-3"}, {type="craft-item", item="piercing-rounds-magazine", count=5000})
update_tech("power-armor-mk2", {"power-armor","military-4"}, {type="craft-item", item="uranium-rounds-magazine", count=1000})
...
update_tech("personal-laser-defense-equipment", {"solar-panel-equipment","power-armor","laser-turret","low-density-structure"}, {type="craft-item", item="laser-turret", count=1000})
...
update_tech("physical-projectile-damage-5", {"military-3","physical-projectile-damage-4"}, {type="craft-item", item="uranium-rounds-magazine", count=10000})
update_tech("physical-projectile-damage-6", {"military-3","physical-projectile-damage-5"}, {type="craft-item", item="uranium-rounds-magazine", count=20000})
update_tech("physical-projectile-damage-7", {"military-4","physical-projectile-damage-6"}, {type="craft-item", item="uranium-rounds-magazine", count=30000})
...
update_tech("weapon-shooting-speed-5", {"military-3","weapon-shooting-speed-4"}, {type="craft-item", item="uranium-rounds-magazine", count=2500})
update_tech("weapon-shooting-speed-6", {"military-3","weapon-shooting-speed-5"}, {type="craft-item", item="uranium-rounds-magazine", count=5000})
...
update_tech("solar-energy", {"steel-processing","electronics"}, {type="craft-item", item="electronic-circuit", count=5000})
update_tech("radar", {"military","electronics"}, {type="craft-item", item="electronic-circuit", count=1000})
...
update_tech("concrete", {"advanced-material-processing"}, {type="craft-item", item="stone-brick", count=10000})
update_tech("low-density-structure", {"advanced-material-processing","advanced-circuit"}, {type="craft-item", item="plastic-bar", count=5000})

update_tech("automobilism", {"logistics-2","engine"}, {type="craft-item", item="engine-unit", count=500})
update_tech("tank", {"automobilism","explosives","military-3"}, {type="craft-item", item="cannon-shell", count=500})
...
update_tech("uranium-ammo", {"tank","uranium-processing"}, {type="craft-item", item="uranium-238", count=1000})
...
update_tech("laser-turret", {"laser","military-3"}, {type="craft-item", item="battery", count=5000})

update_tech("laser-shooting-speed-1", {"laser"}, {type="craft-item", item="laser-turret", count=100})
update_tech("laser-shooting-speed-2", {"laser-shooting-speed-1"}, {type="craft-item", item="laser-turret", count=500})
update_tech("laser-shooting-speed-3", {"laser-shooting-speed-2"}, {type="craft-item", item="laser-turret", count=1000})
update_tech("laser-shooting-speed-4", {"laser-shooting-speed-3"}, {type="craft-item", item="laser-turret", count=1500})
update_tech("laser-shooting-speed-5", {"laser-shooting-speed-4","military-4"}, {type="craft-item", item="laser-turret", count=2000})
update_tech("laser-shooting-speed-6", {"laser-shooting-speed-5"}, {type="craft-item", item="laser-turret", count=3000})
update_tech("laser-shooting-speed-7", {"laser-shooting-speed-6"}, {type="craft-item", item="laser-turret", count=4000})

update_tech("laser-weapons-damage-1", {"laser"}, {type="craft-item", item="laser-turret", count=250})
update_tech("laser-weapons-damage-2", {"laser-weapons-damage-1"}, {type="craft-item", item="laser-turret", count=750})
update_tech("laser-weapons-damage-3", {"laser-weapons-damage-2"}, {type="craft-item", item="laser-turret", count=1750})
update_tech("laser-weapons-damage-4", {"laser-weapons-damage-3"}, {type="craft-item", item="laser-turret", count=2500})
update_tech("laser-weapons-damage-5", {"laser-weapons-damage-4","military-4"}, {type="craft-item", item="laser-turret", count=3500})
update_tech("laser-weapons-damage-6", {"laser-weapons-damage-5"}, {type="craft-item", item="laser-turret", count=4500})
update_tech("laser-weapons-damage-7", {"laser-weapons-damage-6"}, {type="craft-item", item="laser-turret", count=5500})

update_tech("cliff-explosives", {"explosives","military-2"}, {type="craft-item", item="explosives", count=10000})

update_tech("research-speed-1", {"automation-2"}, {type="craft-item", item="lab", count=50})
update_tech("research-speed-2", {"research-speed-1"}, {type="craft-item", item="lab", count=100})
update_tech("research-speed-3", {"research-speed-2","advanced-circuit"}, {type="craft-item", item="lab", count=200})
update_tech("research-speed-4", {"research-speed-3"}, {type="craft-item", item="lab", count=300})
update_tech("research-speed-5", {"research-speed-4","productivity-module"}, {type="craft-item", item="lab", count=400})
update_tech("research-speed-6", {"research-speed-5","processing-unit"}, {type="craft-item", item="lab", count=500})
...
update_tech("nuclear-power", {"uranium-processing"}, {type="craft-item", item="uranium-ore", count=5000})
...
update_tech("explosive-rocketry", {"rocketry"}, {type="craft-item", item="rocket", count=5000})
...
update_tech("effect-transmission", {"productivity-module","advanced-material-processing-2","processing-unit"}, {type="craft-item", item="processing-unit", count=500})
...
update_tech("logistics-4", {"logistics-3"}, {type="craft-item", item="express-transport-belt", count=30000})
update_tech("logistics-5", {"logistics-4","processing-unit"}, {type="craft-item", item="turbo-transport-belt", count=50000})
...
update_tech("Compression-tech", {"metal-pressing","advanced-material-processing-2"}, {type="craft-item", item="metal-press-machine", count=100})
...
update_tech("metal-pressing", {"efficiency-module-2","productivity-module-2","miniturization"}, {type="craft-item", item="stone", count=100000})
...
update_tech("lamp", {"electronics"}, {type="craft-item", item="glass-plate", count=500})
...
update_tech("aai-strongbox-base", {"steel-processing"}, {type="craft-item", item="steel-chest", count=100})
update_tech("aai-storehouse-base", {"aai-strongbox-base","concrete"}, {type="craft-item", item="aai-strongbox", count=100})
update_tech("aai-warehouse-base", {"aai-storehouse-base"}, {type="craft-item", item="aai-storehouse", count=100})

update_tech("aai-strongbox-storage", {"aai-strongbox-base","logistic-robotics"}, {type="craft-item", item="aai-strongbox", count=500})
update_tech("aai-storehouse-storage", {"aai-strongbox-storage","aai-storehouse-base"}, {type="craft-item", item="aai-storehouse", count=500})
update_tech("aai-warehouse-storage", {"aai-storehouse-storage","aai-warehouse-base"}, {type="craft-item", item="aai-warehouse", count=500})

update_tech("aai-strongbox-logistic", {"aai-strongbox-storage","logistic-system"}, {type="craft-item", item="aai-strongbox", count=1000})
update_tech("aai-storehouse-logistic", {"aai-strongbox-logistic","aai-storehouse-storage"}, {type="craft-item", item="aai-storehouse", count=1000})
update_tech("aai-warehouse-logistic", {"aai-storehouse-logistic","aai-warehouse-storage"}, {type="craft-item", item="aai-warehouse", count=1000})
